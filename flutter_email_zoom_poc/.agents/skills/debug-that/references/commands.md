...
dbg attach [pid|ws-url|port]        # Attach to running process / VM service
dbg attach --runtime flutter        # Let Flutter discover a running app
...
--runtime NAME                       # Debug adapter: lldb, codelldb, flutter, etc. (use lldb/codelldb for native debugging)
--tool-arg ARG                       # Repeat to pass raw tool args to Dart/Flutter launches
--device ID                          # Flutter device shorthand (-d <id>)
--json                               # JSON output
